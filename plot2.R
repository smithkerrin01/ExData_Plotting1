...
## accommodate the "Plot 2" title. The default width and height parameters
## for png are both 480.

png(file="./plotdata/plot2.png")
par(oma=c(2,2,2,2))
...
## Add the Plot 2 title to the outer margin
mtext("Plot 2", side= 3, outer = TRUE, font=2, adj=0)
